...
const submit = () => {
    form.transform(data => ({
        ...data,
        gallery_urls: galleryItems.value.filter(i => !i.file).map(i => i.url),
    ...
    <AdminLayout>
            ...
            <div class="flex flex-col lg:flex-row gap-5">
                ...
                <div class="flex-1 min-w-0 space-y-5">
                    ...
                    <div class="bg-white border border-[#c3c4c7] shadow-sm">
                        <input v-model="form.name" type="text" placeholder="Nhập tên sản phẩm tại đây"
                            class="w-full border-0 border-b border-[#dcdcde] text-[#1d2327] text-lg py-3 px-3 focus:ring-0 focus:border-[#2271b1] focus:shadow-[0_0_0_1px_#2271b1] placeholder-[#a7aaad]" required />
                    ...
                    <div class="bg-white border border-[#c3c4c7] shadow-sm">
                        ...
                        <div class="p-3">
                            <textarea v-model="form.short_description" rows="3" placeholder="Nhập mô tả ngắn gọn về sản phẩm..."
                                class="w-full border-[#8c8f94] rounded text-[13px] py-2 focus:border-[#2271b1] focus:ring-1 focus:ring-[#2271b1]"></textarea>
                        </div>
                ...
                <div class="w-full lg:w-[280px] shrink-0 space-y-5">
                    ...
                    <div class="bg-white border border-[#c3c4c7] shadow-sm">
                        ...
                        <div class="border-t border-[#c3c4c7] bg-[#f6f7f7] px-3 py-2 flex justify-between items-center">
                            <Link :href="route('admin.products.index')" class="text-[13px] text-[#b32d2e] hover:text-[#a02929] hover:underline">Hủy</Link>
        ...
        <Modal :show="showPancakeModal" @close="closePancakeModal">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-600 mb-6">Bạn cần cài đặt cấu hình Pancake POS (API Token và Shop ID) để có thể đồng bộ sản phẩm về hệ thống POS.</p>
                <div class="flex justify-end gap-3">
                    <SecondaryButton @click="closePancakeModal">Để sau</SecondaryButton>
                    <Link :href="route('admin.pancake.settings')"
