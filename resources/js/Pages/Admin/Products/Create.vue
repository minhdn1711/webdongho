            ...
            <div class="p-6">
                <div class="flex items-center gap-3 mb-4 text-[#d63638]">
                    ...
                    <h2 class="text-lg font-medium text-gray-900">
                        Cấu hình Pancake POS chưa hoàn tất
                    </h2>
                </div>
                ...
                <div class="flex justify-end gap-3">
                    <SecondaryButton @click="closePancakeModal">
                        Để sau
                    </SecondaryButton>
                    <Link 
                        :href="route('admin.pancake.settings')"
                        class="inline-flex items-center px-4 py-2 bg-[#2271b1] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#135e96] focus:bg-[#135e96] active:bg-[#135e96] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
                    >
                        Cài đặt ngay
                    </Link>
                </div>
