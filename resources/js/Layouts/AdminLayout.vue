...
const menuItems = [
    ...
    { name: 'Menu', icon: 'M4 6h16M4 12h16M4 18h16', url: '/admin/menus' },
    ...
    { name: 'Đánh giá', icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z', url: '/admin/reviews' },
    { name: 'Tin tức', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l4 4v10a2 2 0 01-2 2zM7 8h4m-4 4h8m-8 4h8', url: '/admin/posts' },
    { name: 'Banners', icon: 'M4 5a1 1 0 011-1h14a1 1 0 011 1v12a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 8h16', url: '/admin/banners' },
    { name: 'Tính năng nổi bật', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', url: '/admin/site-features' },
    ...
    <div class="flex h-screen bg-gray-100 font-sans">
        ...
        >
            ...
            <div class="h-12 flex items-center px-4 bg-[#191e23]">
                <Link :href="route('dashboard')" class="flex items-center gap-2 overflow-hidden">
                    <img v-if="settings.logo" :src="settings.logo" :alt="settings.site_name || 'Logo'" class="admin-brand-logo w-8 h-8 shrink-0 rounded-full bg-white p-1 object-contain" />
                    ...
                    <span v-show="isSidebarOpen" class="text-white font-bold text-lg tracking-tight truncate">
                        {{ settings.site_name || 'Web Đồng Hồ' }}
                    </span>
                </Link>
            </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <footer class="bg-white border-t border-gray-200 py-4 px-6 text-center text-sm text-gray-500 shrink-0">
                <p>&copy; 2026 Miliwebseo - Hệ thống quản trị chuyên nghiệp.</p>
            </footer>
        </div>
